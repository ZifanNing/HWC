...
def handle_inputs():
    ...
    parser = options.define_args(filename='_compare_CIFAR100_bir', description='Compare different components of BI-R on permuted MNIST.')
...
def barplots(result_list1, result_list2, names1, names2, ids, colors, seed_list, only_last_dir, chance_level=None, long_names1=None, long_names2=None, ylabel=None, title=None, ylim=None, perc=False, neg=False):
...
if __name__ == '__main__':
    ...
    print('\n{}\n'.format(title) + '-' * 60)
    figure = barplots(ave_prec_sg, ave_prec_bir, names_sg, names_bir, ids, colors, seed_list, only_last_dir=ONLYLAST, chance_level=10, long_names1=long_names_sg, long_names2=long_names_bir, ylabel=ylabel, title=title, ylim=None, perc=True)
