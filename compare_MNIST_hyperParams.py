...
lamda_list = [1., 10., 100., 1000., 10000., 100000., 1000000., 10000000., 100000000., 1000000000., 10000000000., 100000000000.]
gamma_list = [1.]
...
def handle_inputs():
    ...
    parser = options.define_args(filename='_compare_MNIST_hyperParams', description='Compare hyperparameters of EWC, online EWC, SI and XdG on different \'scenarios\' of splitMNIST.')
    ...
    parser.add_argument('--no-online', action='store_true', help='dont do online EWC')
